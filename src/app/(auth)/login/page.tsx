  ...
  return (
    <section className="rounded-3xl border border-border bg-card/95 p-6 shadow-xl shadow-black/5 backdrop-blur sm:p-8">
      ...
      <div className="mt-8 space-y-1">
        <h1 className="font-sans text-3xl font-semibold leading-tight">Sign in</h1>
        <p className="text-sm text-muted-foreground">Sign in with Google or local account.</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        No account?{" "}
        <Link href="/register" className="font-semibold text-foreground transition hover:text-primary">
          Create one
        </Link>
      </p>
    </section>
